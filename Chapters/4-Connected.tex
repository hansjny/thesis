...
\begin{figure}
	\centering
		\subfloat[Two neighbouring nodes]{{\includegraphics[width=6cm]{Images/mergestep1.png} }}%
		\qquad
		\subfloat[A and B merges. A third node appears]{{\includegraphics[width=6cm]{Images/mergestep2.png} }}%
		\newline
		\subfloat[All nodes joined in transient group]{{\includegraphics[width=6cm]{Images/mergestep3.png} }}%
		\qquad
		\subfloat[Splitting to reduce group size]{{\includegraphics[width=6cm]{Images/mergestep4.png} }}%
...
\begin{figure}
	\centering
		\subfloat[Without K-means splitting]{{\includegraphics[width=3cm]{Images/computations/TynsetNear.jpg} }}%
		\qquad
...
\begin{figure}
	\centering
		\subfloat[Two groups are initially too large to merge. A split is going to be attempted. ]{{\includegraphics[width=6cm]{Images/mincutstep1.png} }}%
		\qquad
		\subfloat[Both groups identify edges which should not be cut, marked by an infinite edge weight]{{\includegraphics[width=6cm]{Images/mincutstep2.png} }}%
		\newline
		\subfloat[The groups excludes the partitions with the lowest capacity cuts]{{\includegraphics[width=6cm]{Images/mincutstep3.png} }}%
		\qquad
		\subfloat[The number of members of the groups combined is now lower than maximum size, and the merge is succesful]{{\includegraphics[width=6cm]{Images/mincutstep4.png} }}%
...
The results of the simulation with the  implementation of minimum cut splitting can be seen in figure \ref{fig:mincutresults}.
They are the same four topologies that have been used on previous simulations. 

\begin{figure}
	\centering
		\subfloat[Uniform]{{\includegraphics[width=6cm]{Images/computations/MINCUT500_500.png} }}%
		\qquad
		\subfloat[Forks]{{\includegraphics[width=6cm]{Images/computations/MINCUT_FORKS.png} }}%
		\newline
		\subfloat[Lillehammer]{{\includegraphics[width=6cm]{Images/computations/MINCUT_LILLEHAMMER.png} }}%
		\qquad
		\subfloat[Tynset]{{\includegraphics[width=6cm]{Images/computations/MINCUT_TYNSET.png} }}%
...
Our group computations has been based on the signal strength of all nearby access points, and the dBi values that denotes all signal strengths were calculated using the free space path loss formula.
As distance is the only variable that affects the result of our signal strength calculation, it means that the signal strength levels becomes a symmetric binary relation between nodes. In the real world 
this is not the case. Access points may interfere with each other differently, and the signal strength values may change when there are variations in the environment. This is the reasons deadlocks could
