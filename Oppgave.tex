...
To enable collaborative channel allocation, it is important for every AP to know which other APs it is collaborating with.
...
The group should have a maximum amount of participants. If a group exceeds the maximum size, it has to kick out the members that influences the group the least. By influencing we are
referring to how loud other members of the group can hear the AP in question. To prevent the group from oscillating between kicking out members and rejoining members, once it reaches
its maximum size, it should be locked for further
group memberships once it reaches its maximum size. An important requirement is that nodes that influences eachother strongly should always be a part of the same group, and not be
