...
\section{Results}
Here we will present three scenarios where the group allocation data is based on actual AP-data, and the topology can be
put on top of a map of the same area to give us some insight of what happens. 
