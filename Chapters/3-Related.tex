...
According to the paper which describes the previously mentioned algorithms \cite{Basagni}, the following properties have to be satisfied for any ad-hoc clustering algorithm:
\begin{enumerate}
