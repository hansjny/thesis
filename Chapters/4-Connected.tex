...
real circumstances. Hence some major adaptions would have to be made to get this to work in an implementation.
...
the centroid node would know their distance to the centroid. Then, using a relay network to communicate internally in the group, figure out the approximate
distance from all nodes not within sensing range of the centroid. It is unknown if such an approach would be accurate enough to work, or have a complexity that is conceivable to implement.  
